 ...
 * @author nomar
 */
public class FrmEditarCatalogoClientes extends javax.swing.JFrame {
     ...
     */
    public FrmEditarCatalogoClientes() {
        initComponents();
     ...
     */
    private void editarCliente(registrarClienteDTO cliente) throws NegocioException {
        try {
    ...
    private void initComponents() {
        ...
        lbl_registro.setText("Editar Cliente");
    ...
    private void btnRegistroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistroActionPerformed
        ...
        try {
            ...
            Logger.getLogger(FrmEditarCatalogoClientes.class.getName()).log(Level.SEVERE, null, ex);
        }
